...
<!-- Mirrored from devitems.com/html/Eshop-preview/Eshop/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Jul 2018 08:36:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Eshop || Wishlist</title>
                                                ...
                                                <div class="magamenu ">
                                                    <ul class="again">
                                                        <li class="single-menu colmd4">
                                                            ...
                                                            <a href="javascript:void(0);">shirts & top</a>
                                                            <a href="javascript:void(0);">shoes</a>
                                                            <a href="javascript:void(0);">dresses</a>
                                                            <a href="javascript:void(0);">shwmwear</a>
                                                        </li>
                                                        <li class="single-menu colmd4">
                                    ...
                                    <div class="mobile-menu">
                                        <nav id="dropdown">
                                            <ul>
                                                ...
                                                <li><a href="shop.html">Shop</a>
                                                    <ul>
                                                        <li><a href="javascript:void(0);">all products</a>
                                                            <ul>
                                                                <li>
                                                                    <span>men’s wear</span>
                                                                    <a href="javascript:void(0);">shirts & top</a>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a href="javascript:void(0);">rings</a>
                                                                    <a href="javascript:void(0);">sweaters</a>
                                                                    <a href="javascript:void(0);">persess</a>
                                                                    <a href="javascript:void(0);">bags</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li><a href="javascript:void(0);">New products</a>
                                                            <ul>
                                                                <li>
                                                                    <span>men’s wear</span>
                                                                    <a href="javascript:void(0);">shirts & top</a>
                                                        ...
                                                        <li><a href="javascript:void(0);">best sell</a>
                                                            <ul>
                                                                <li>
                                                                    <span>men’s wear</span>
                                                                    <a href="javascript:void(0);">shirts & top</a>
                                                        ...
                                                        <li><a href="javascript:void(0);">features products</a>
                                                            <ul>
                                                                <li>
                                                                    <span>men’s wear</span>
                                                                    <a href="javascript:void(0);">shirts & top</a>
                                                        ...
                                                        <li><a href="javascript:void(0);">popular products</a>
                                                            <ul>
                                                                <li>
                                                                    <span>men’s wear</span>
                                                                    <a href="javascript:void(0);">shirts & top</a>
                                            ...
                                            <ul class="drop-cart">
                                                <li>
                                                    ...
                                                    <div class="add-cart-text">
                                                        <p><a href="javascript:void(0);">White Shirt</a></p>
                                                        <p>$50.00</p>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="con-text">
                            ...
                            <p><a href="javascript:void(0);">Home</a> | Wishlist</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="cart-form table-responsive">
                                <table id="shopping-cart-table" class="data-table cart-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="sop-cart">
                                            <a href="javascript:void(0);"><img class="primary-image" alt="" src="img/products/10.jpg"></a>
                                        </td>
                                        <td class="sop-cart an-sh">
                                            <div class="tb-beg">
                                                <a href="javascript:void(0);">Vintage Shoe</a>
                                            </div>
                                            <div class="last-cart l-mrgn">
                                                <a class="las4" href="javascript:void(0);">Quick View</a>
                                            </div>
                                        </td>
                                        <td class="sop-cart">
                                    ...
                                    <tr>
                                        ...
                                        <td class="sop-cart">
                                            <a href="javascript:void(0);"><img class="primary-image" alt="" src="img/products/15.jpg"></a>
                                        </td>
                                        <td class="sop-cart an-sh">
                                            <div class="tb-beg">
                                                <a href="javascript:void(0);">Vintage Glasses</a>
                                            </div>
                                            <div class="last-cart l-mrgn">
                                                <a class="las4" href="javascript:void(0);">Quick View</a>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="sop-cart">
                                            <a href="javascript:void(0);"><img class="primary-image" alt="" src="img/products/1.jpg"></a>
                                        </td>
                                        <td class="sop-cart an-sh">
                                            <div class="tb-beg">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <div class="yith-wcwl-share">
                                                    ...
                                                    <ul>
                                                        <li><a href="javascript:void(0);"><img src="img/icon-img/facebook.png" alt=""></a></li>
                                                        <li><a href="javascript:void(0);"><img src="img/icon-img/twitter.png" alt=""></a></li>
                                                        <li><a href="javascript:void(0);"><img src="img/icon-img/pinterest.jpg" alt=""></a></li>
                                                        <li><a href="javascript:void(0);"><img src="img/icon-img/googleplus.jpg" alt=""></a></li>
                                                        <li><a href="javascript:void(0);"><img src="img/icon-img/email.jpg" alt=""></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
								...
								<div class="single-text res-text">
									...
									<div class="footer-menu">
										<ul>
											...
											<li><a href="order-complete.html">My Orders</a></li>
											<li><a href="javascript:void(0);">My Credit slips</a></li>
											<li class="nm"><a href="javascript:void(0);">My Addresses</a></li>
										</ul>
									</div>
								</div>
							</div>
								...
								<div class="single-text res-text">
									...
									<div class="footer-menu">
										<ul>
											...
											<li class="nm"><a href="javascript:void(0);">Gift Vouchers</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-xs-12 hidden-sm col-md-3 margin-top">
								<div class="single-text res-text">
									...
									<div class="footer-text">
										...
										<form action="https://devitems.com/html/Eshop-preview/Eshop/mail.php" method="post">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="social-icon">
									<ul class="floatright">
										<li class="res-mar"><a href="javascript:void(0);"><i class="fa fa-facebook"></i></a></li>
...
<!-- Mirrored from devitems.com/html/Eshop-preview/Eshop/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Jul 2018 08:37:00 GMT -->
</html>
