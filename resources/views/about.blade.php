        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="con-text">
                    ...
                    <p><a href="javascript:void(0);">Home</a> | About Us</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="about-us-all">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="about-optima-text">
                            ...
                            <a class="learn_btn" href="/categories">Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single-creative-member res2">
                        ...
                        <div class="member-info">
                            ...
                            <div class="member-social">
                                <a class="m-facebook" href="javascript:void(0);">
                                    <i class="fa fa-facebook"></i>
                                </a>
                                <a class="m-twitter" href="javascript:void(0);">
                                    <i class="fa fa-twitter"></i>
                                </a>
                                <a class="m-g-plus" href="javascript:void(0);">
                                    <i class="fa fa-google-plus"></i>
                                </a>
                                <a class="m-linkedin" href="javascript:void(0);">
